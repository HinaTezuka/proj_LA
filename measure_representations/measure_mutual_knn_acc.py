...
model_L2_name = "DiscoResearch/Llama3-DiscoLeo-Instruct-8B-v0.1"
...
# dataset = load_dataset("tatoeba", lang1="en", lang2="de", split="train")  # Replace "L2" with the actual second language
...
texts_L2 = [sample['translation']['gem'] for sample in dataset.select(range(n_samples))]
