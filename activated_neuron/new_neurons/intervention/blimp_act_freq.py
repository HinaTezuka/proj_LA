...
act_freq_L1_specific = act_freq_dict["specific_neurons_L1"]
...
act_freq_base_shared = act_freq_base_dict["shared_neurons"]
...
for layer_idx, neurons in act_freq_L1_specific.items():
    for neuron_idx in neurons.keys():
...
# sort
layer_neuron_list_L1_specific = sorted(layer_neuron_list_L1_specific, key=lambda x: act_freq_L1_specific[x[0]][x[1]], reverse=True)
...
print(shared_same_semantics)
print(display_activation_values(shared_same_semantics, act_freq_shared))
sys.exit()
...
if __name__ == "__main__":
    ...
    # save as csv
    df_main.to_csv(f"/home/s2410121/proj_LA/activated_neuron/new_neurons/intervention/csv/llama3/act_freq/blimp/{active_THRESHOLD}_th/shared_same_semantics/{dir_path}/en_{L2}.csv", index=False)
    ...
    df_shared_non_translation.to_csv(f"/home/s2410121/proj_LA/activated_neuron/new_neurons/intervention/csv/llama3/act_freq/blimp/{active_THRESHOLD}_th/shared_non_same_semantics/{dir_path}/en_{L2}.csv", index=False)
    ...
    df_comp.to_csv(f"/home/s2410121/proj_LA/activated_neuron/new_neurons/intervention/csv/llama3/act_freq/blimp/{active_THRESHOLD}_th/normal_COMP/{dir_path}/en_{L2}.csv", index=False)
    ...
    df_comp_L1_or_L2.to_csv(f"/home/s2410121/proj_LA/activated_neuron/new_neurons/intervention/csv/llama3/act_freq/blimp/{active_THRESHOLD}_th/L1_or_L2/{dir_path}/en_{L2}.csv", index=False)
    ...
    df_comp_L1_specific.to_csv(f"/home/s2410121/proj_LA/activated_neuron/new_neurons/intervention/csv/llama3/act_freq/blimp/{active_THRESHOLD}_th/L1_specific/{dir_path}/en_{L2}.csv", index=False)
